...
waffle_2.set_pixel(2, 2, "yellow")
waffle_2.set_pixel(1, 1, "purple")
waffle_3.set_pixel(2, 0, "yellow")
waffle_2.set_pixel(2, 1, "blue")
waffle_3.set_pixel(2, 2, "green")
waffle_3.set_pixel(0, 1, "pink")
waffle_3.set_pixel(2, 1, "red")


#Module 2 coding
Msequence = ['4', '3', '5', '3', '1', '4']
sequence = []*6
...
button1 = PushButton(module2, command=counter1, image="C:/Users/Bryan/Desktop/guizero/Weird1D.png", grid=[0,1])
button1.width = 80
button1.height = 80
...
button3.width = 80
button3.height = 80
button4  = PushButton(module2, command=counter4, image="C:/Users/Bryan/Desktop/guizero/Weird2D.jpg", grid=[0,2])
button4.width = 80
button4.height = 80
