from guizero import App, Text, Waffle, Combo, TextBox, Window, PushButton, CheckBox, Picture 
...
def YellowCheck():
    timer_3.value = int(timer_3.value) - 30
    MadeW = Text(module3, text="1", size = 20, font="Times New Roman", color="Green", grid = [550, 80])
    
def RedCheck():
    Made = Text(module3, text="0", size = 20, font="Times New Roman", color="Green", grid = [550, 40])
...
waffle_2.set_pixel(2, 1, "yellow")
waffle_2.set_pixel(2, 2, "green")
waffle_2.set_pixel(1, 1, "purple")
waffle_3.set_pixel(2, 0, "blue")
waffle_2.set_pixel(2, 1, "blue")
waffle_3.set_pixel(2, 2, "black")
waffle_3.set_pixel(0, 1, "purple")
waffle_3.set_pixel(2, 1, "orange")

#Module 2 coding
Msequence = ['2', '2', '5', '3', '1', '4']
sequence = []*6
...
button1.width = 80
button1.height = 80
button2 = PushButton(module2, command=counter2, image="C:/Users/Bryan/Desktop/guizero/Weird4A.jpg", grid=[1,1])
button2.width = 80
button2.height = 80
button3  = PushButton(module2, command=counter3, image="C:/Users/Bryan/Desktop/guizero/Weird6A.jpg", grid=[2,2])
button3.width = 80
button3.height = 80
button4  = PushButton(module2, command=counter4, image="C:/Users/Bryan/Desktop/guizero/Weird2A.png", grid=[0,2])
button4.width = 80
button4.height = 80
button5  = PushButton(module2, command=counter5, image="C:/Users/Bryan/Desktop/guizero/Weird3A.png", grid=[1,3])
button5.width = 80
button5.height = 80
button6  = PushButton(module2, command=counter6, image="C:/Users/Bryan/Desktop/guizero/Weird5A.png", grid=[2,3])
button6.width = 80
button6.height = 80
...
YellowPic.width = 150
YellowPic.height = 40
Correct1 = Text(module3, text = "1", size = 1, font = "Times New Roman", grid=[500, 480])
